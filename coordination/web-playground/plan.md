...
## Batch 8 — pong's gameplay as a project, and script editing on the page — LANDED 2026-09-05 (59365d4 in insiculous_2d, 23c5471 in games/pong; the site half is staged in insiculous_web and held for `npm run verify` and Jesse's browser check)
