...
| K | Conductor — shared MIDI parts, custom instruments and in-editor composition | Next after Phase G (Jesse, Sep 25 2026); P1 on board, K1 spike gates all | [Conductor milestone](https://github.com/beinsiculous/insiculous_2d/milestone/2): #60–#65, #140 (sample instruments), #141 (composer); the tickets carry the settled design and dependency order |
