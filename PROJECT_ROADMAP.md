...
| K | Conductor — shared MIDI parts, custom instruments and in-editor composition | Next after Phase G (Jesse, Sep 25 2026); P1 on board, K1 spike gates all. Scope stays whole: the in-engine composer (K8) is a feature that sets the engine apart for music-oriented game developers, not a cut candidate | [Conductor milestone](https://github.com/beinsiculous/insiculous_2d/milestone/2): #60–#65, #140 (sample instruments), #141 (composer); the tickets carry the settled design and dependency order |
