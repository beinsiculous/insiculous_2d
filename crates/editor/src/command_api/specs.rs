...
pub fn command_docs() -> &'static [CommandDoc] {
    const DOCS: &[CommandDoc] = &[
        ...
        CommandDoc {
            ...
            summary: "Shallow-patch a component with raw JSON (unknown fields are an error; enums replace whole). One undo entry per line.",
            writes: true,
            undoable: true,
        },
        CommandDoc {
            ...
            summary: "Add a component (default-valued, optionally patched) — one undo entry.",
            writes: true,
            undoable: true,
        },
        CommandDoc {
